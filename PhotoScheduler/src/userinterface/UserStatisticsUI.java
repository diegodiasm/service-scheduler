 ...
 * @author Diego Dias
 */
public class UserStatisticsUI extends javax.swing.JPanel {

    /**
     * Creates new form ServersStatisticsUI
     */
    public UserStatisticsUI() {

        Controller ctrl = Controller.getInstance();

        initComponents();
        ctrl.frUserStatisticsUICreateTable(this);
        ctrl.frUserStatisticsUIRefreshTable(this);
    }
    ...
    private void btImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btImprimirActionPerformed
        ...
        MessageFormat header = new MessageFormat("Relatório de Agendamento: "
